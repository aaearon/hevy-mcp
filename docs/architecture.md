...
| Package           | Owns                                                                                                                                                              |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/node`   | stdio transport, local Streamable HTTP and `http+oauth` transports, process lifecycle (`SIGTERM`/`SIGINT`), stdio parse hardening. No telemetry, no update check. |
