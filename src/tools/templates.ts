...
export function registerTemplateTools(
	...
	server.registerTool(
		...
		withErrorHandling(async (args: GetExerciseTemplatesParams) => {
			...
			return createJsonResponse({ exerciseTemplates });
		}, "get-exercise-templates"),
	);
	...
	server.registerTool(
		"get-exercise-template",
		{
			...
			outputSchema: { exerciseTemplate: formattedExerciseTemplateSchema },
		...
		withErrorHandling(async (args: GetExerciseTemplateParams) => {
			...
			const exerciseTemplate = formatExerciseTemplate(data);
			return createJsonResponse({ exerciseTemplate });
		}, "get-exercise-template"),
	);
	...
	server.registerTool(
		"get-exercise-history",
		{
			...
			outputSchema: {
				history: z.array(formattedExerciseHistoryEntrySchema),
			},
	...
	server.registerTool(
		"create-exercise-template",
		{
			...
			outputSchema: {
				exerciseTemplate: z.record(z.string(), z.unknown()),
			},
	...
	server.registerTool(
		...
		withErrorHandling(async (args: SearchExerciseTemplatesParams) => {
			...
			return createJsonResponse({
				exerciseTemplates: results.map(formatExerciseTemplate),
			});
		}, "search-exercise-templates"),
	);
}
